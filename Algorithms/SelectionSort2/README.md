...
### Imitating Sedgewick's Java Code in Python

Java has a special class to inherit from for sorting programs, I believe it is called the Comparable interface? Does Python have something similar that could be used with sorting programs ?
